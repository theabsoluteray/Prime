...
""", color=config.color)
    ...
    self.embed.add_field(
        name="Main",
        value=f"**<:automod_blaze:1168964010218098699> : Auto Moderation\n<:Mod_blaze:1168964187519717396> : Moderation\n<:gw_blaze:1168965639810068581> : Giveaway\n<:ticket_blaze:1168965751596650557> : Ticket\n<:utility_blaze:1168965881427152918> : Utility\n<:wlc_blaze:1168966085375184898> : Welcome**"
    )
    self.embed.add_field(
        name="Extra",
        value=f"**<:ar_blaze:1168966326858039417> : Auto Responder\n<:logging_blaze:1168966480499593247> : Logging\n<:media_blaze:1168966606727168012> : Media\n<:vc_blaze:1168966739049062460> : Voice Command\n<:fun_blaze:1168968032748576819> : Fun\n<:lnl_prime:1168949404993065130> : Bot**"
    )
    ...
    class HelpPanel(discord.ui.View):
        ...
        async def callback(self, interaction: discord.Interaction, select: Select):
            ...
            if select.values[0] == "Auto Moderation":
                ...
                embed = discord.Embed(title=cog.qualified_name + " <:IconNew1:1168968845864742984><:icons_new2:1168968848972722219>", description=f", ".join(f"`{i.qualified_name}`" for i in cog.walk_commands()), color=config.color)
                embed.set_author(name=self.author, icon_url=self.author.display_avatar.url)
                embed.set_footer(text="Powered By Devlopment HQ", icon_url=interaction.client.user.display_avatar)
    ...
    self.embed.set_footer(text=f"Powered by Devlopment HQ", icon_url=self.context.bot.user.display_avatar.url)
