...
async def get_prefix(client, message):
    if str(message.channel.type) == 'private':
        return await message.channel.send("Currently Prime is not available in DMs.")
...
client.owner_ids = [810352682823843861,1043194242476036107]
...
ultron = "MTA5MDAxMTc2NDcyMjI0MTU4Ng.GdW4Xa.2jNsRGSYBjJU9IzwaeCYCoLzFXknoV5GxwH2pQ"
